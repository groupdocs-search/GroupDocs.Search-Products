...
############################# Head ############################
head_title: "Búsqueda boolean en DOCX con Java"
...
steps:
    enable: true
    title: "Cómo realizar búsquedas booleanas en documentos DOCX"
    content: |
      [GroupDocs.Search](/search/java/) permite realizar búsquedas de texto dentro de documentos DOCX. Con soporte para condiciones booleanas, puedes mejorar la precisión de las búsquedas en aplicaciones de Java.
      
      1. Especifica la carpeta para almacenar el índice de búsqueda.
      2. Selecciona la carpeta que contiene documentos DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Uso de consultas complejas de búsqueda booleanas"
      content: |
        Este ejemplo demuestra cómo realizar búsquedas booleanas en archivos DOCX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
