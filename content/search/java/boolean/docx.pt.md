...
############################# Head ############################
head_title: "Pesquisa Booleana em DOCX com Java"
...
steps:
    enable: true
    title: "Como realizar buscas booleanas em documentos DOCX"
    content: |
      [GroupDocs.Search](/search/java/) permite buscas de texto dentro de documentos DOCX. Com suporte a condições booleanas, você pode aumentar a precisão da busca em aplicações Java.
      
      1. Especifique a pasta para armazenar o índice de busca.
      2. Selecione a pasta que contém documentos DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Usando consultas de busca booleana complexas"
      content: |
        Este exemplo demonstra como realizar buscas booleanas em arquivos DOCX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
