...
head_description: "Create and insert barcode signatures into PPTX documents in Java with ease. GroupDocs.Search enables versatile signature integration for multiple formats."
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/java/) can generate barcodes in various popular formats and place them on PPTX pages. With support for over 60 barcode types, Java applications can easily be enhanced with barcode signing capabilities by incorporating our library.
      ...
      code:
        ...
        top_links:
          ...
          - title: "Download result"
            icon: "download"
            link: "/examples/search/formats/search_boolean.pptx"
        links:
          #  loop
          - title: "More examples"
            link: "https://github.com/groupdocs-search/GroupDocs.Search-for-Java/"
