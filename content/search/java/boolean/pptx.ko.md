...
############################# Head ############################
head_title: "PPTX에서 Java를 이용한 불리언 검색"
...
steps:
    enable: true
    title: "PPTX 문서에서 불리언 검색을 수행하는 방법"
    content: |
      [GroupDocs.Search](/search/java/)은 PPTX 문서 내에서 텍스트 검색을 수행할 수 있도록 지원합니다. 불리언 조건을 지원하여 Java 애플리케이션에서 검색 정확성을 높일 수 있습니다.
      
      1. 검색 색인을 저장할 폴더를 지정합니다.
      2. PPTX 문서가 포함된 폴더를 선택합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "복잡한 불리언 검색 쿼리 사용"
      content: |
        이 예제에서는 PPTX 파일에서 불리언 검색을 수행하는 방법을 보여줍니다.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
