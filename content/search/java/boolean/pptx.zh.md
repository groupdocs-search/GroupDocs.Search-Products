...
steps:
    enable: true
    title: "如何在PPTX文档中执行布尔搜索"
    content: |
      [GroupDocs.Search](/search/java/)使得在PPTX文档中进行文本搜索成为可能。通过支持布尔条件，您可以在Java应用程序中提高搜索精度。
