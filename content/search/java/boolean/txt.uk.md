...
############################# Head ############################
head_title: "Буліевий пошук у TXT з Java"
...
steps:
    enable: true
    title: "Як здійснити булеві пошуки в документах TXT"
    content: |
      [GroupDocs.Search](/search/java/) дозволяє здійснювати текстові пошуки в документах TXT. Завдяки підтримці булевих умов ви можете покращити точність пошуку в програмах Java.
      
      1. Вкажіть папку для зберігання індексу пошуку.
      2. Виберіть папку з документами TXT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Використання складних булевих запитів"
      content: |
        Цей приклад демонструє, як виконувати булеві пошуки у файлах TXT.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
