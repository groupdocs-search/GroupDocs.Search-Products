...
############################# Head ############################
head_title: "Pencarian Boolean di XLSX dengan Java"
...
steps:
    enable: true
    title: "Cara melakukan pencarian boolean dalam dokumen XLSX"
    content: |
      [GroupDocs.Search](/search/java/) memfasilitasi pencarian teks dalam dokumen XLSX. Dengan dukungan untuk kondisi boolean, Anda dapat meningkatkan akurasi pencarian dalam aplikasi Java.
