...
############################# Head ############################
head_title: "Lakukan Pencarian Sensitif Huruf di DOCX dengan Java"
...
steps:
    enable: true
    title: "Panduan untuk Pencarian Sensitif Huruf di File DOCX"
    content: |
      Dengan [GroupDocs.Search](/search/java/), Anda dapat melakukan pencarian sensitif huruf dalam dokumen DOCX, meningkatkan proyek Java Anda.
