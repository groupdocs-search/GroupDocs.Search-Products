...
############################# Head ############################
head_title: "DOCXでのケースセンシティブ検索をJavaで行う"
...
steps:
    enable: true
    title: "DOCXファイルにおけるケースセンシティブ検索のガイド"
    content: |
      [GroupDocs.Search](/search/java/)を使用すると、DOCXドキュメントでケースセンシティブ検索が可能になり、Javaプロジェクトが向上します。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "例：ケースセンシティブ検索クエリ"
      content: |
        この例では、DOCX文書に対してケースセンシティブ検索を実装する方法を示しています。
      code:
        title: "Java"
        content: |
          ```java {style=abap}
