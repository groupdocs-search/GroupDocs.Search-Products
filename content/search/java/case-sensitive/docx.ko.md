...
############################# Head ############################
head_title: "DOCX에서 Java의 대소문자를 구분하는 검색 수행"
...
steps:
    enable: true
    title: "DOCX 파일에서 대소문자 구분 검색하기"
    content: |
      [GroupDocs.Search](/search/java/)을(를) 사용하여 DOCX 문서에서 대소문자 구분 검색을 수행하여 Java 프로젝트를 향상시킬 수 있습니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "예제: 대소문자 구분 검색 쿼리"
      content: |
        이 예제는 DOCX 문서를 위한 대소문자 구분 검색을 구현하는 방법을 보여줍니다.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
