...
############################# Head ############################
head_title: "Fall-Insensitive Suchen in PDF mit Java"
...
steps:
    enable: true
    title: "Leitfaden zur groß-/kleinschreibungssensitiven Suche in PDF Dateien"
    content: |
      Mit [GroupDocs.Search](/search/java/) können Sie groß-/kleinschreibungssensitive Suchen in PDF Dokumenten durchführen und Ihre Java Projekte erweitern.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Beispiel: Groß-/Kleinschreibungssensitive Suchabfragen"
      content: |
        Dieses Beispiel zeigt, wie Sie groß-/kleinschreibungssensitive Suchen für PDF Dokumente implementieren können.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
