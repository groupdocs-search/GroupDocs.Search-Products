...
############################# Head ############################
head_title: "Realiza Búsquedas Sensibles a Mayúsculas en PPTX con Java"
...
steps:
    enable: true
    title: "Guía para Búsqueda Sensible a Mayúsculas en Archivos PPTX"
    content: |
      Usando [GroupDocs.Search](/search/java/), puedes realizar búsquedas sensibles a mayúsculas en documentos PPTX, mejorando tus proyectos de Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ejemplo: Consultas de Búsqueda Sensible a Mayúsculas"
      content: |
        Este ejemplo demuestra cómo implementar búsquedas sensibles a mayúsculas para documentos PPTX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
