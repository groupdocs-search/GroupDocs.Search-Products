...
############################# Head ############################
head_title: "Effectuez des recherches sensibles à la casse dans PPTX avec Java"
...
steps:
    enable: true
    title: "Guide pour la Recherche Sensible à la Casse dans des Fichiers PPTX"
    content: |
      En utilisant [GroupDocs.Search](/search/java/), vous pouvez effectuer des recherches sensibles à la casse dans des documents PPTX, améliorant ainsi vos projets Java.
      
      1. Définissez le dossier pour stocker l'index de recherche.
      2. Sélectionnez le dossier contenant des fichiers PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Exemple : Requêtes de Recherche Sensibles à la Casse"
      content: |
        Cet exemple montre comment mettre en œuvre des recherches sensibles à la casse pour des documents PPTX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
