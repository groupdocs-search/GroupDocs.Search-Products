...
############################# Head ############################
head_title: "在PPTX中使用Java进行区分大小写的搜索"
...
steps:
    enable: true
    title: "在PPTX文件中进行区分大小写搜索的指南"
    content: |
      使用[GroupDocs.Search](/search/java/)，您可以在PPTX文档中执行区分大小写的搜索，从而增强您的Java项目。
