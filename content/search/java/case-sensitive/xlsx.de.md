...
############################# Head ############################
head_title: "Fall-Insensitive Suchen in XLSX mit Java"
...
steps:
    enable: true
    title: "Leitfaden zur groß-/kleinschreibungssensitiven Suche in XLSX Dateien"
    content: |
      Mit [GroupDocs.Search](/search/java/) können Sie groß-/kleinschreibungssensitive Suchen in XLSX Dokumenten durchführen und Ihre Java Projekte erweitern.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Beispiel: Groß-/Kleinschreibungssensitive Suchabfragen"
      content: |
        Dieses Beispiel zeigt, wie Sie groß-/kleinschreibungssensitive Suchen für XLSX Dokumente implementieren können.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
