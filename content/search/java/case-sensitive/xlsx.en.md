...
############################# Head ############################
head_title: "Perform Case-Sensitive Searches in XLSX with Java"
...
steps:
    enable: true
    title: "Guide to Case-Sensitive Search in XLSX Files"
    content: |
      Using [GroupDocs.Search](/search/java/), you can easily perform case-sensitive searches in XLSX documents, enhancing your Java projects.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Example: Case-Sensitive Search Queries"
      content: |
        This example demonstrates how to implement case-sensitive searches for XLSX documents.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
        ...
        top_links:
          ...
          - title: "Download result"
            icon: "download"
            link: "/examples/search/formats/search_case-sensitive.xlsx"
        links:
          #  loop
          - title: "More examples"
            link: "https://github.com/groupdocs-search/GroupDocs.Search-for-Java/"
