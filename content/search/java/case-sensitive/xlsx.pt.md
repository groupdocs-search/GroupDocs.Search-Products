...
############################# Head ############################
head_title: "Realize Pesquisas Sensíveis a Maiúsculas em XLSX com Java"
...
steps:
    enable: true
    title: "Guia para Busca Sensível a Maiúsculas em Arquivos XLSX"
    content: |
      Usando [GroupDocs.Search](/search/java/), você pode realizar busca sensível a maiúsculas em documentos XLSX, aprimorando seus projetos Java.
      
      1. Defina a pasta para armazenar o índice de busca.
      2. Selecione a pasta contendo arquivos XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Exemplo: Consultas de Busca Sensível a Maiúsculas"
      content: |
        Este exemplo demonstra como implementar buscas sensíveis a maiúsculas para documentos XLSX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
