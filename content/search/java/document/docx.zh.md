...
############################# Head ############################
head_title: "使用适用于Java的GroupDocs.Search在DOCX文档中查找文本"
...
steps:
    enable: true
    title: "在 DOCX 文件中执行文本搜索"
    content: |
      [GroupDocs.Search](/search/java/) 使得在 DOCX 文件中使用复杂的逻辑和索引进行搜索变得简单，从而提高 Java 应用程序中的搜索准确性。
...
more_formats:
    enable: true
    title: "使用 GroupDocs.Search 在 DOCX 文档中查找信息"
    exclude: "DOCX"
