...
draft: false
path: "ru/search/java/document/odt"
...
############################# Header ############################
title: "Java API для ODT операций индексирования и поиска документов"
...
steps:
    ...
    - title_left: "Синхронное индексирование документов ODT через Java"
      content_left: |
      ...
      title_right: "Синхронно добавить документ ODT в поисковый индекс"
      content_right: |
        * Для начала нужно указать путь к папке index
    ...
    - title_left: "Выполнение асинхронного индексирования документов через Java"
      ...
      title_right: "Добавить документ ODT в поисковый индекс асинхронно"
      content_right: |
        * Для начала нужно указать путь к папке index
        * Укажите путь к папке с документами для поиска
        * Создайте экземпляр класса [Index(indexFolder)](https://apireference.groupdocs.com/search/java/com.groupdocs.search/Index#Index(java.lang.String))
