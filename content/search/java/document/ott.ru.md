...
draft: false
path: "ru/search/java/document/ott"
...
############################# Header ############################
title: "Java API для OTT операций индексирования и поиска документов"
...
steps:
    ...
    - title_left: "Синхронное индексирование документов OTT через Java"
      content_left: |
      ...
      title_right: "Синхронно добавить документ OTT в поисковый индекс"
      content_right: |
        * Для начала нужно указать путь к папке index
    ...
    - title_left: "Выполнение асинхронного индексирования документов через Java"
      ...
      title_right: "Добавить документ OTT в поисковый индекс асинхронно"
      content_right: |
        * Для начала нужно указать путь к папке index
        * Укажите путь к папке с документами для поиска
        * Создайте экземпляр класса [Index(indexFolder)](https://apireference.groupdocs.com/search/java/com.groupdocs.search/Index#Index(java.lang.String))
