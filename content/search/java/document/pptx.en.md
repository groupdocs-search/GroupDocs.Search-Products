...
############################# Head ############################
head_title: "Boolean search in PPTX with Java"
...
steps:
    enable: true
    title: "How to perform boolean searches in PPTX documents"
    content: |
      [GroupDocs.Search](/search/java/) enables easy text searches within PPTX documents. With support for boolean conditions, you can enhance search accuracy in Java applications.
      
      1. Specify the folder to store the search index.
      2. Select the folder containing PPTX documents.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Using complex boolean search queries"
      content: |
        This example demonstrates how to perform Boolean searches in PPTX files.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
        ...
        top_links:
          ...
          - title: "Download result"
            icon: "download"
            link: "/examples/search/formats/search_document.pptx"
        links:
          #  loop
          - title: "More examples"
            link: "https://github.com/groupdocs-search/GroupDocs.Search-for-Java/"
