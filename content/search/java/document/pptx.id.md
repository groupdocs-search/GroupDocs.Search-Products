...
############################# Head ############################
head_title: "Temukan teks dalam dokumen PPTX dengan GroupDocs.Search untuk Java"
...
steps:
    enable: true
    title: "Lakukan pencarian teks dalam file PPTX"
    content: |
      [GroupDocs.Search](/search/java/) memudahkan pencarian file PPTX menggunakan logika canggih dan pengindeksan, meningkatkan akurasi pencarian dalam aplikasi Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Menerapkan kueri pencarian canggih"
      content: |
        Contoh ini menggambarkan bagaimana menggunakan kueri pencarian untuk mencari dalam dokumen PPTX secara efisien.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
...
more_formats:
    enable: true
    title: "Temukan informasi di dokumen PPTX dengan GroupDocs.Search"
    exclude: "PPTX"
