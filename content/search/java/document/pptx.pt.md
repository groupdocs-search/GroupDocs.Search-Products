...
############################# Head ############################
head_title: "Encontre texto em documentos PPTX com GroupDocs.Search para Java"
...
steps:
    enable: true
    title: "Realizar buscas textuais em arquivos PPTX"
    content: |
      [GroupDocs.Search](/search/java/) facilita a busca em arquivos PPTX usando lógica sofisticada e indexação, melhorando a precisão das buscas nas aplicações Java.
      
      1. Configure um diretório para armazenar o índice de busca.
      2. Escolha uma pasta contendo arquivos PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Implementando consultas de busca avançadas"
      content: |
        Este exemplo ilustra como usar consultas de busca para pesquisar dentro de documentos PPTX de forma eficiente.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
...
more_formats:
    enable: true
    title: "Encontre informações em documentos PPTX com GroupDocs.Search"
    exclude: "PPTX"
