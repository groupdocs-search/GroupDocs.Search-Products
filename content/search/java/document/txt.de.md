...
############################# Head ############################
head_title: "Text in TXT-Dokumenten mit GroupDocs.Search für Java finden"
...
steps:
    enable: true
    title: "Durchsuchung von Texten in TXT-Dateien durchführen"
    content: |
      [GroupDocs.Search](/search/java/) ermöglicht es, TXT-Dateien mithilfe komplexer Logik und Indizierung zu durchsuchen, was die Suchgenauigkeit in Java-Anwendungen verbessert.
      
      1. Richten Sie ein Verzeichnis zur Speicherung des Suchindexes ein.
      2. Wählen Sie einen Ordner mit TXT-Dateien aus.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Implementierung fortgeschrittener Suchabfragen"
      content: |
        Dieses Beispiel zeigt, wie man Suchabfragen verwendet, um effizient in TXT-Daten zu suchen.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
...
more_formats:
    enable: true
    title: "Informationen in TXT-Dokumenten mit GroupDocs.Search finden"
    exclude: "TXT"
