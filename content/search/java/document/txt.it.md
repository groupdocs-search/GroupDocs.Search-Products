...
############################# Head ############################
head_title: "Trova testo nei documenti TXT con GroupDocs.Search per Java"
...
steps:
    enable: true
    title: "Esegui ricerche testuali nei file TXT"
    content: |
      [GroupDocs.Search](/search/java/) facilita la ricerca nei file TXT utilizzando logiche sofisticate e indicizzazione, migliorando la precisione della ricerca nelle applicazioni Java.
      
      1. Configura una directory per memorizzare l'indice di ricerca.
      2. Scegli una cartella contenente file TXT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Implementazione di query di ricerca avanzate"
      content: |
        Questo esempio illustra come utilizzare query di ricerca per cercare in modo efficiente all'interno dei documenti TXT.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
...
more_formats:
    enable: true
    title: "Trova informazioni nei documenti TXT con GroupDocs.Search"
    exclude: "TXT"
