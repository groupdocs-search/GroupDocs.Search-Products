...
############################# Head ############################
head_title: "Знайдіть текст у документах TXT з GroupDocs.Search для Java"
...
steps:
    enable: true
    title: "Виконання текстових пошуків у файлах TXT"
    content: |
      [GroupDocs.Search](/search/java/) спрощує пошук у файлах TXT за допомогою складної логіки та індексування, підвищуючи точність пошуку в додатках Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Реалізація розширених запитів пошуку"
      content: |
        Цей приклад ілюструє, як використовувати запити пошуку для ефективного пошуку у документах TXT.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
...
more_formats:
    enable: true
    title: "Знайдіть інформацію у документах TXT з GroupDocs.Search"
    exclude: "TXT"
