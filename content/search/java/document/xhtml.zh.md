...
draft: false
path: "zh/search/java/document/xhtml"
...
############################# Header ############################
title: "XHTML 文档索引和搜索操作的 java API"
...
steps:
    ...
    - title_left: "通过 Java 执行异步文档索引"
      ...
      title_right: "异步添加 XHTML 文档到搜索索引"
      content_right: |
        * 首先您需要指定索引文件夹的路径
        * 指定包含要搜索的文档的文件夹的路径
        * 创建 [Index(indexFolder)](https://apireference.groupdocs.com/search/java/com.groupdocs.search/Index#Index(java.lang.String)) 类的实例
    ...
    - title_left: "如何在 Java 应用程序中突出显示搜索结果"
      content_left: |
       GroupDocs.Search Java API 允许开发人员解释搜索结果并列出找到的文档以及单词和短语。 也可以突出显示 XHTML 文档的文本。 下面的 Java 代码示例演示了如何仅用几行代码列出找到的文档并突出显示搜索结果。
