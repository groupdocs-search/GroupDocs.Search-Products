...
draft: false
path: "zh/search/java/document/xlam"
...
############################# Header ############################
title: "XLAM 文档索引和搜索操作的 java API"
...
steps:
    ...
    - title_left: "如何在 Java 应用程序中突出显示搜索结果"
      content_left: |
       GroupDocs.Search Java API 允许开发人员解释搜索结果并列出找到的文档以及单词和短语。 也可以突出显示 XLAM 文档的文本。 下面的 Java 代码示例演示了如何仅用几行代码列出找到的文档并突出显示搜索结果。
