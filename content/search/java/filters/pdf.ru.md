...
############################# Head ############################
head_title: "Поиск в документах PDF с использованием Java"
...
steps:
    enable: true
    title: "Как осуществлять поиск в документах PDF"
    content: |
      [GroupDocs.Search](/search/java/) позволяет быстро и эффективно искать текст в документах PDF, идеально подходит для приложений Java.
      
      1. Укажите папку для хранения индекса поиска.
      2. Выберите папку, содержащую ваши документы.
      3. Настройте параметры поиска, чтобы ограничить результаты документами PDF.
