...
draft: false
path: "de/search/java/filters/potx/"
...
############################# Head ############################
head_title: "POTX Dokumentfilterung in Suchergebnis über Java-API integrieren?"
head_description: "GroupDocs.Search Java API hilft Softwareentwicklern, POTX Suchfunktionen für Dokumente hinzuzufügen und Dokumentfilter anzuwenden, um Suchergebnisse über Java API anzupassen."

############################# Header ############################
title: "So integrieren Sie die Dokumentenfilterung, um Suchergebnisse in Java-Apps anzupassen"
description: "GroupDocs.Search Java API ermöglicht Programmierern die Integration erweiterter POTX Dokumentsuchfunktionen sowie die Anpassung von Suchergebnissen, indem sie die Dokumentfilterung in ihren Java-Apps festlegen."
...
steps:
    enable: true
    block:
    - title_left: "Dokumentfilter beim Durchsuchen von POTX-Dokumenten über Java anwenden"
      content_left: |
      ...
      title_right: "Dokumentfiltereinstellung beim Durchsuchen von POTX Dokumenten"
      content_right: |
    ...
    - title_left: "Kombinieren Sie Suchdokumentfilter, um einen zusammengesetzten Filter über Java zu erstellen"
      ...
      title_right: "Erstellen Sie einen zusammengesetzten Filter, um POTX-Dateien zu durchsuchen"
      content_right: |
       * Zuerst müssen Sie den Pfad zum Indexordner und Dokumentenordner angeben.
