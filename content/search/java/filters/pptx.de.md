...
############################# Head ############################
head_title: "In PPTX-Dokumenten mit Java suchen"
...
steps:
    enable: true
    title: "So suchen Sie in PPTX-Dokumenten"
    content: |
      [GroupDocs.Search](/search/java/) ermöglicht schnelle und effektive Textsuchen in PPTX-Dokumenten, ideal für Java-Anwendungen.
      
      1. Geben Sie einen Ordner an, um den Suchindex zu speichern.
      2. Wählen Sie den Ordner mit Ihren Dokumenten aus.
      3. Konfigurieren Sie die Suchoptionen, um die Ergebnisse auf PPTX-Dokumente zu beschränken.
