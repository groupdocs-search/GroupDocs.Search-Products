...
############################# Head ############################
head_title: "Integrate XLA Document Filtering in Search Result via Java API?"
head_description: "GroupDocs.Search Java API helps software developers to add XLA documents searching capabilities & apply document filtering to customize search results via Java API."

############################# Header ############################
title: "How to Integrate Document Filtering to Customize Search Results inside Java Apps"
description: "GroupDocs.Search Java API allows programmers  to Integrate advanced XLA document searching functionalities as well as  customize searching results by setting document filtering in their Java apps."
...
steps:
    enable: true
    block:
    - title_left: "Apply Document Filter in Searching XLA Documents via Java"
      content_left: |
      ...
      title_right: "Document Filter Setting in Searching XLA Documents"
      content_right: |
    ...
    - title_left: "Combine Search Document Filters to Create Composite Filter via Java"
      ...
      title_right: "Create Composite Filter to Search XLA Files"
      content_right: |
       * First you need to Specify the path to the index folder & document folder.
