...
############################# Head ############################
head_title: "In XLSX-Dokumenten mit Java suchen"
...
steps:
    enable: true
    title: "So suchen Sie in XLSX-Dokumenten"
    content: |
      [GroupDocs.Search](/search/java/) ermöglicht schnelle und effektive Textsuchen in XLSX-Dokumenten, ideal für Java-Anwendungen.
      
      1. Geben Sie einen Ordner an, um den Suchindex zu speichern.
      2. Wählen Sie den Ordner mit Ihren Dokumenten aus.
      3. Konfigurieren Sie die Suchoptionen, um die Ergebnisse auf XLSX-Dokumente zu beschränken.
