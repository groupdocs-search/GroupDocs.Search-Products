...
############################# Head ############################
head_title: "Recherchez dans les documents XLSX en utilisant Java"
...
steps:
    enable: true
    title: "Comment rechercher dans des documents XLSX"
    content: |
      [GroupDocs.Search](/search/java/) permet des recherches textuelles rapides et efficaces dans des documents XLSX, parfait pour les applications Java.
      
      1. Spécifiez un dossier pour stocker l'index de recherche.
      2. Sélectionnez le dossier contenant vos documents.
      3. Configurez les options de recherche pour limiter les résultats aux documents XLSX.
