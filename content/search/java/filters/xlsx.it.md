...
############################# Head ############################
head_title: "Cerca in documenti XLSX utilizzando Java"
...
steps:
    enable: true
    title: "Come cercare in documenti XLSX"
    content: |
      [GroupDocs.Search](/search/java/) consente ricerche testuali rapide ed efficienti in documenti XLSX, perfette per applicazioni Java.
      
      1. Specifica una cartella per memorizzare l'indice di ricerca.
      2. Seleziona la cartella contenente i tuoi documenti.
      3. Configura le opzioni di ricerca per limitare i risultati ai documenti XLSX.
