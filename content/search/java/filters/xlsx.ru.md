...
############################# Head ############################
head_title: "Поиск в документах XLSX с использованием Java"
...
steps:
    enable: true
    title: "Как осуществлять поиск в документах XLSX"
    content: |
      [GroupDocs.Search](/search/java/) позволяет быстро и эффективно искать текст в документах XLSX, идеально подходит для приложений Java.
      
      1. Укажите папку для хранения индекса поиска.
      2. Выберите папку, содержащую ваши документы.
      3. Настройте параметры поиска, чтобы ограничить результаты документами XLSX.
