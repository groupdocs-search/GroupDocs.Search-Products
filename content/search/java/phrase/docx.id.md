...
############################# Head ############################
head_title: "Cari frasa dalam DOCX menggunakan Java"
...
steps:
    enable: true
    title: "Cara menemukan frasa dalam dokumen DOCX"
    content: |
      [GroupDocs.Search](/search/java/) menyederhanakan pencarian frasa dalam dokumen DOCX. Gunakan berbagai opsi untuk memperbaiki hasil pencarian dalam aplikasi Java.
      
      1. Buat direktori indeks pencarian.
      2. Tentukan folder dengan file DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Menggunakan metode pencarian canggih"
      content: |
        Pelajari cara menyusun kueri untuk pencarian dalam DOCX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
