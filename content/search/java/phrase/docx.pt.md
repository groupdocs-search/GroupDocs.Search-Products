...
############################# Head ############################
head_title: "Buscar frases em DOCX usando Java"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/java/) simplifica a busca por frases em documentos DOCX. Utilize várias opções para refinar os resultados de busca nas aplicações Java.
      
      1. Crie um diretório para o índice de busca.
      2. Especifique a pasta com arquivos DOCX.
