...
draft: false
path: "ja/search/java/phrase/mhtml/"
...
############################# Header ############################
title: "JavaAPIを介してmhtml_ UPPERドキュメント内の正確な文またはフレーズを検索および表示する方法は？"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してMHTMLドキュメントでフレーズ検索を行う"
      content_left: |
      ...
      title_right: "MHTMLファイルでの正確な文の検索"
      content_right: |
    ...
    - title_left: "Javaを介してMHTMLファイルを介してワイルドカードフレーズ検索を適用する"
      content_left: |
