...
draft: false
path: "ja/search/java/phrase/odt/"
...
############################# Header ############################
title: "JavaAPIを介してodt_ UPPERドキュメント内の正確な文またはフレーズを検索および表示する方法は？"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してODTドキュメントでフレーズ検索を行う"
      content_left: |
    ...
    - title_left: "Javaを介してODTファイルを介してワイルドカードフレーズ検索を適用する"
      content_left: |
