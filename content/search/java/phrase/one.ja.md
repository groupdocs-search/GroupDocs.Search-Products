...
draft: false
path: "ja/search/java/phrase/one/"
...
############################# Header ############################
title: "JavaAPIを介してone_ UPPERドキュメント内の正確な文またはフレーズを検索および表示する方法は？"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してONEドキュメントでフレーズ検索を行う"
      content_left: |
    ...
    - title_left: "Javaを介してONEファイルを介してワイルドカードフレーズ検索を適用する"
      content_left: |
