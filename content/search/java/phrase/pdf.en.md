...
############################# Head ############################
head_title: "Search phrases in PDF using Java"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/java/) simplifies phrase searching in PDF documents. Use various options to refine search results in Java applications.
      
      1. Create a search index directory.
      2. Specify the folder with PDF files.
