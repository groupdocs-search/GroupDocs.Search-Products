...
############################# Head ############################
head_title: "Suchphrasen in PPTX mit Java finden"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/java/) vereinfacht die Phrasensuche in PPTX Dokumenten. Verwenden Sie verschiedene Optionen, um die Suchergebnisse in Java Anwendungen zu verfeinern.
      
      1. Erstellen Sie ein Verzeichnis für den Suchindex.
      2. Geben Sie den Ordner mit PPTX Dateien an.
