...
draft: false
path: "ja/search/java/phrase/pst/"
...
############################# Header ############################
title: "JavaAPIを介してpst_ UPPERドキュメント内の正確な文またはフレーズを検索および表示する方法は？"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してPSTドキュメントでフレーズ検索を行う"
      content_left: |
    ...
    - title_left: "Javaを介してPSTファイルを介してワイルドカードフレーズ検索を適用する"
      content_left: |
