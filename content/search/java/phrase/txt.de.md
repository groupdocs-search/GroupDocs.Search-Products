...
############################# Head ############################
head_title: "Suchphrasen in TXT mit Java finden"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/java/) vereinfacht die Phrasensuche in TXT Dokumenten. Verwenden Sie verschiedene Optionen, um die Suchergebnisse in Java Anwendungen zu verfeinern.
      
      1. Erstellen Sie ein Verzeichnis für den Suchindex.
      2. Geben Sie den Ordner mit TXT Dateien an.
