...
############################# Head ############################
head_title: "TXT에서 구문 검색 수행하기 - GroupDocs.Search for Java"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/java/)는 TXT 문서에서 구문 검색을 간소화합니다. Java 애플리케이션에서 검색 결과를 개선하기 위해 다양한 옵션을 사용하세요.
