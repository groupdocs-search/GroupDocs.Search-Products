...
draft: false
path: "ja/search/java/phrase/xhtml/"
...
############################# Header ############################
title: "JavaAPIを介してxhtml_ UPPERドキュメント内の正確な文またはフレーズを検索および表示する方法は？"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してXHTMLドキュメントでフレーズ検索を行う"
      content_left: |
      ...
      title_right: "XHTMLファイルでの正確な文の検索"
      content_right: |
    ...
    - title_left: "Javaを介してXHTMLファイルを介してワイルドカードフレーズ検索を適用する"
      content_left: |
