...
############################# Head ############################
head_title: "Rechercher des phrases dans XLSX en utilisant Java"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/java/) facilite la recherche de phrases dans des documents XLSX. Utilisez diverses options pour affiner les résultats de recherche dans les applications Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Utilisation de méthodes de recherche avancées"
      content: |
        Apprenez à construire des requêtes pour effectuer des recherches dans XLSX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
