...
draft: false
path: "ja/search/java/phrase/xlt/"
...
############################# Header ############################
title: "JavaAPIを介してxlt_ UPPERドキュメント内の正確な文またはフレーズを検索および表示する方法は？"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してXLTドキュメントでフレーズ検索を行う"
      content_left: |
    ...
    - title_left: "Javaを介してXLTファイルを介してワイルドカードフレーズ検索を適用する"
      content_left: |
