...
############################# Head ############################
head_title: "DOCX 문서 내 검색, .NET에서 불리언 연산자 사용"
...
steps:
    enable: true
    title: "불리언 논리를 사용하여 DOCX 문서 콘텐츠 검색하기"
    content: |
      [GroupDocs.Search](/search/net/)는 DOCX 문서 콘텐츠 검색을 간단하게 해줍니다. .NET 애플리케이션 내에서 결과를 세분화하기 위해 불리언 논리 검색 조건을 제공합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "고급 불리언 검색 쿼리 사용하기"
      content: |
        이 예제는 DOCX 문서 검색을 위한 불리언 쿼리를 적용하는 방법을 보여줍니다.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
