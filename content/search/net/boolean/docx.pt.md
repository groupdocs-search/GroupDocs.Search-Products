...
############################# Head ############################
head_title: "Pesquise DOCX no .NET usando operadores booleanos"
...
steps:
    enable: true
    title: "Como buscar o conteúdo de documentos DOCX usando lógica booleana"
    content: |
      [GroupDocs.Search](/search/net/) torna a busca pelo conteúdo de documentos DOCX direta. Ele fornece condições de busca de lógica booleana para refinar os resultados nas aplicações .NET.
      
      1. Especifique a pasta para armazenar o índice de busca.
      2. Escolha a pasta contendo os arquivos DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Usando consultas de busca booleanas avançadas"
      content: |
        Este exemplo demonstra como aplicar consultas booleanas para pesquisar documentos DOCX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
