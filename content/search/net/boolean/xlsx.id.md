...
############################# Head ############################
head_title: "Cari XLSX di .NET menggunakan operator boolean"
...
steps:
    enable: true
    title: "Cara mencari konten dokumen XLSX menggunakan logika boolean"
    content: |
      [GroupDocs.Search](/search/net/) membuat pencarian konten dokumen XLSX menjadi sederhana. Ini menyediakan kondisi pencarian logika Boolean untuk memperhalus hasil di aplikasi .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Menggunakan kueri pencarian boolean yang canggih"
      content: |
        Contoh ini menunjukkan bagaimana menerapkan kueri boolean untuk mencari dokumen XLSX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
