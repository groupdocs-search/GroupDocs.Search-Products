...
############################# Head ############################
head_title: "在 .NET 中使用布尔运算符搜索 XLSX"
...
steps:
    enable: true
    title: "如何使用布尔逻辑搜索 XLSX 文档内容"
    content: |
      [GroupDocs.Search](/search/net/) 使搜索 XLSX 文档内容变得简单。它提供布尔逻辑搜索条件以在 .NET 应用程序中细化结果。
