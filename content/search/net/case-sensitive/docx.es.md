...
############################# Head ############################
head_title: "Búsqueda Sensible a Mayúsculas en DOCX Usando .NET"
...
steps:
    enable: true
    title: "Cómo Realizar Búsqueda Sensible a Mayúsculas en Documentos DOCX"
    content: |
      [GroupDocs.Search](/search/net/) simplifica la búsqueda sensible a mayúsculas en documentos DOCX. Úsalo para refinar resultados en aplicaciones .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Uso de Consultas de Búsqueda Sensibles a Mayúsculas"
      content: |
        Este ejemplo muestra cómo utilizar consultas sensibles a mayúsculas para buscar documentos DOCX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
