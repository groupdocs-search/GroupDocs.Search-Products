...
############################# Head ############################
head_title: "在DOCX中使用.NET进行区分大小写的搜索"
...
steps:
    enable: true
    title: "如何在DOCX文档中执行区分大小写的搜索"
    content: |
      [GroupDocs.Search](/search/net/)简化了在DOCX文档中的区分大小写搜索。可用于在.NET应用程序中细化结果。
