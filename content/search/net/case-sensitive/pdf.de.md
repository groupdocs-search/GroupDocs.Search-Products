...
############################# Head ############################
head_title: "Groß- und Kleinschreibungssensible Suche in PDF mit .NET"
...
steps:
    enable: true
    title: "So führen Sie eine groß- und kleinschreibungssensible Suche in PDF Dokumenten durch"
    content: |
      [GroupDocs.Search](/search/net/) vereinfacht die groß- und kleinschreibungssensible Suche in PDF Dokumenten. Nutzen Sie es, um die Ergebnisse in .NET Anwendungen zu verfeinern.
      
      1. Definieren Sie den Ordner zur Speicherung des Suchindexes.
      2. Wählen Sie den Ordner mit PDF Dateien aus.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Verwendung groß- und kleinschreibungssensibler Suchanfragen"
      content: |
        Dieses Beispiel zeigt, wie man groß- und kleinschreibungssensible Suchanfragen zur Suche in PDF Dokumenten verwendet.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
