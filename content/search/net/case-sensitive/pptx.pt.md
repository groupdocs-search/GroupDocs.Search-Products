...
############################# Head ############################
head_title: "Busca Sensível a Maiúsculas em PPTX Usando .NET"
...
steps:
    enable: true
    title: "Como Realizar Busca Sensível a Maiúsculas em Documentos PPTX"
    content: |
      [GroupDocs.Search](/search/net/) simplifica a busca sensível a maiúsculas em documentos PPTX. Utilize-o para refinar resultados em aplicações .NET.
      
      1. Defina a pasta para armazenar o índice de busca.
      2. Escolha a pasta que contém os arquivos PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Usando Consultas de Busca Sensíveis a Maiúsculas"
      content: |
        Este exemplo demonstra como usar consultas sensíveis a maiúsculas para buscar documentos PPTX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
