...
############################# Header ############################
title: "How to Add Instant Documents Search to CHM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for CHM Document via .NET API"
      content_left: |
