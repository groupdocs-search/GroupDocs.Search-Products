...
############################# Header ############################
title: "How to Add Instant Documents Search to CSV via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for CSV Document via .NET API"
      content_left: |
