...
draft: false
path: "zh/search/net/document/csv/"
...
############################# Header ############################
title: "如何通过 C# .NET API 将即时文档搜索添加到 CSV"
...
steps:
    enable: true
    block:
    - title_left: "通过 .NET API 为 CSV 文档创建搜索索引"
      content_left: |
    ...
    - title_left: "如何将 CSV 文档同步添加到搜索索引"
      content_left: |
