...
############################# Header ############################
title: "How to Add Instant Documents Search to DOC via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for DOC Document via .NET API"
      content_left: |
