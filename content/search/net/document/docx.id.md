...
############################# Head ############################
head_title: "Cari dokumen DOCX di .NET dengan GroupDocs.Search"
...
steps:
    enable: true
    title: "Cara melakukan pencarian teks di dokumen DOCX"
    content: |
      [GroupDocs.Search](/search/net/) memungkinkan operasi pencarian konten canggih dalam dokumen DOCX, memungkinkan hasil pencarian yang lebih terperinci dalam aplikasi .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Melakukan kueri pencarian yang canggih"
      content: |
        Contoh ini menunjukkan bagaimana menerapkan kueri pencarian untuk dokumen DOCX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
