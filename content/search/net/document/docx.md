...
############################# Header ############################
title: "How to Add Instant Documents Search to DOCX via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for DOCX Document via .NET API"
      content_left: |
