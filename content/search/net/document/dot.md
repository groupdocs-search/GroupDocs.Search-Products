...
############################# Header ############################
title: "How to Add Instant Documents Search to DOT via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for DOT Document via .NET API"
      content_left: |
