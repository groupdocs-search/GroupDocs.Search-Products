...
############################# Header ############################
title: "How to Add Instant Documents Search to DOTM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for DOTM Document via .NET API"
      content_left: |
