...
draft: false
path: "ru/search/net/document/dotm/"
...
############################# Header ############################
title: "Как добавить мгновенный поиск документов в DOTM через C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Создание индекса поиска для документа DOTM с помощью .NET API"
      content_left: |
    ...
    - title_left: "Как синхронно добавить документы DOTM в поисковый индекс"
      content_left: |
    ...
    - title_left: "Выполнение асинхронного индексирования документов через .NET"
      ...
      title_right: "Асинхронное DOTM индексирование документов с помощью C#"
      content_right: |
        * Для начала нужно указать путь к папке index
        * Укажите путь к папке с документами для поиска
        * Создайте экземпляр класса [Index(indexFolder)](https://apireference.groupdocs.com/search/net/groupdocs.search.indexrepository/search/methods/2).
    ...
    - title_left: "Как использовать и выделять результаты поиска в DOTM Docs .NET"
      content_left: |
      ...
      title_right: "Выделение результатов поиска в файлах DOTM с помощью C#"
      content_right: |
        * Поиск по индексу
