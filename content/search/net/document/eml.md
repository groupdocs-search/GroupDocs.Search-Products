...
############################# Header ############################
title: "How to Add Instant Documents Search to EML via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for EML Document via .NET API"
      content_left: |
