...
############################# Header ############################
title: "How to Add Instant Documents Search to EPUB via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for EPUB Document via .NET API"
      content_left: |
