...
############################# Header ############################
title: "How to Add Instant Documents Search to FB2 via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for FB2 Document via .NET API"
      content_left: |
