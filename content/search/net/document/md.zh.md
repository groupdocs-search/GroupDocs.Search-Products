...
draft: false
path: "zh/search/net/document/md/"
...
############################# Header ############################
title: "如何通过 C# .NET API 将即时文档搜索添加到 MD"
...
steps:
    enable: true
    block:
    - title_left: "通过 .NET API 为 MD 文档创建搜索索引"
      content_left: |
