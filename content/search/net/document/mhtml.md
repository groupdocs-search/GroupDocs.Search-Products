...
draft: false
path: "search/net/document/mhtml"
...
############################# Header ############################
title: "How to Add Instant Documents Search to MHTML via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for MHTML Document via .NET API"
      content_left: |
