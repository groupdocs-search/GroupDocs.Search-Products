...
############################# Header ############################
title: "How to Add Instant Documents Search to MSG via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for MSG Document via .NET API"
      content_left: |
