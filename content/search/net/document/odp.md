...
############################# Header ############################
title: "How to Add Instant Documents Search to ODP via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for ODP Document via .NET API"
      content_left: |
