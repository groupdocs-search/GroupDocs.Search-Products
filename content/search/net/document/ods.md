...
############################# Header ############################
title: "How to Add Instant Documents Search to ODS via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for ODS Document via .NET API"
      content_left: |
