...
draft: false
path: "ru/search/net/document/ods/"
...
############################# Header ############################
title: "Как добавить мгновенный поиск документов в ODS через C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Создание индекса поиска для документа ODS с помощью .NET API"
      content_left: |
    ...
    - title_left: "Как синхронно добавить документы ODS в поисковый индекс"
      content_left: |
    ...
    - title_left: "Выполнение асинхронного индексирования документов через .NET"
      ...
      title_right: "Асинхронное ODS индексирование документов с помощью C#"
      content_right: |
        * Для начала нужно указать путь к папке index
        * Укажите путь к папке с документами для поиска
        * Создайте экземпляр класса [Index(indexFolder)](https://apireference.groupdocs.com/search/net/groupdocs.search.indexrepository/search/methods/2).
    ...
    - title_left: "Как использовать и выделять результаты поиска в ODS Docs .NET"
      content_left: |
      ...
      title_right: "Выделение результатов поиска в файлах ODS с помощью C#"
      content_right: |
        * Поиск по индексу
