...
############################# Header ############################
title: "How to Add Instant Documents Search to ONE via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for ONE Document via .NET API"
      content_left: |
