...
############################# Header ############################
title: "How to Add Instant Documents Search to OST via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for OST Document via .NET API"
      content_left: |
