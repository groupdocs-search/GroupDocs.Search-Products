...
############################# Header ############################
title: "How to Add Instant Documents Search to OTS via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for OTS Document via .NET API"
      content_left: |
