...
draft: false
path: "ru/search/net/document/ots/"
...
############################# Header ############################
title: "Как добавить мгновенный поиск документов в OTS через C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Создание индекса поиска для документа OTS с помощью .NET API"
      content_left: |
    ...
    - title_left: "Как синхронно добавить документы OTS в поисковый индекс"
      content_left: |
    ...
    - title_left: "Выполнение асинхронного индексирования документов через .NET"
      ...
      title_right: "Асинхронное OTS индексирование документов с помощью C#"
      content_right: |
        * Для начала нужно указать путь к папке index
        * Укажите путь к папке с документами для поиска
        * Создайте экземпляр класса [Index(indexFolder)](https://apireference.groupdocs.com/search/net/groupdocs.search.indexrepository/search/methods/2).
    ...
    - title_left: "Как использовать и выделять результаты поиска в OTS Docs .NET"
      content_left: |
      ...
      title_right: "Выделение результатов поиска в файлах OTS с помощью C#"
      content_right: |
        * Поиск по индексу
