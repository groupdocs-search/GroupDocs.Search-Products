...
############################# Header ############################
title: "How to Add Instant Documents Search to OTT via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for OTT Document via .NET API"
      content_left: |
