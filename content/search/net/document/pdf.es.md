...
############################# Head ############################
head_title: "Buscar documentos PDF en .NET con GroupDocs.Search"
...
steps:
    enable: true
    title: "Cómo realizar una búsqueda de texto en documentos PDF"
    content: |
      [GroupDocs.Search](/search/net/) permite operaciones de búsqueda de contenido avanzadas en documentos PDF, permitiendo resultados de búsqueda refinados en aplicaciones .NET.
      
      1. Configure la carpeta para almacenar el índice de búsqueda.
      2. Elija la carpeta que contiene archivos PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ejecutando consultas de búsqueda avanzadas"
      content: |
        Este ejemplo demuestra cómo aplicar consultas de búsqueda para documentos PDF.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
