...
############################# Head ############################
head_title: "Cerca documenti PDF in .NET con GroupDocs.Search"
...
steps:
    enable: true
    title: "Come eseguire una ricerca di testo nei documenti PDF"
    content: |
      [GroupDocs.Search](/search/net/) abilita operazioni avanzate di ricerca del contenuto nei documenti PDF, consentendo risultati di ricerca affinati nelle applicazioni .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Esecuzione di query di ricerca avanzate"
      content: |
        Questo esempio dimostra come applicare query di ricerca per documenti PDF.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
