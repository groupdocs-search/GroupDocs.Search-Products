...
############################# Head ############################
head_title: "PDF 문서를 .NET에서 GroupDocs.Search으로 검색하기"
...
steps:
    enable: true
    title: "PDF 문서에서 텍스트 검색 수행 방법"
    content: |
      [GroupDocs.Search](/search/net/)은(는) PDF 문서에서 고급 콘텐츠 검색 작업을 가능하게 하여, .NET 애플리케이션에서 세분화된 검색 결과를 제공합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "고급 검색 쿼리 실행하기"
      content: |
        이 예제는 PDF 문서에 대한 검색 쿼리를 적용하는 방법을 보여줍니다.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
