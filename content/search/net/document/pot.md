...
############################# Header ############################
title: "How to Add Instant Documents Search to POT via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for POT Document via .NET API"
      content_left: |
