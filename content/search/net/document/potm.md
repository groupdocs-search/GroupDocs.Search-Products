...
############################# Header ############################
title: "How to Add Instant Documents Search to POTM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for POTM Document via .NET API"
      content_left: |
