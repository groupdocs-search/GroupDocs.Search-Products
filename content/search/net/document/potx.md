...
############################# Header ############################
title: "How to Add Instant Documents Search to POTX via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for POTX Document via .NET API"
      content_left: |
