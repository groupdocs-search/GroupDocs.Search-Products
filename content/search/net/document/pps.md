...
############################# Header ############################
title: "How to Add Instant Documents Search to PPS via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for PPS Document via .NET API"
      content_left: |
