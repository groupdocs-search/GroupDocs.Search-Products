...
############################# Header ############################
title: "How to Add Instant Documents Search to PPSM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for PPSM Document via .NET API"
      content_left: |
