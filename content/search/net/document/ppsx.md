...
############################# Header ############################
title: "How to Add Instant Documents Search to PPSX via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for PPSX Document via .NET API"
      content_left: |
