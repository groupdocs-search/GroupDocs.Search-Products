...
draft: false
path: "ru/search/net/document/ppsx/"
...
############################# Header ############################
title: "Как добавить мгновенный поиск документов в PPSX через C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Создание индекса поиска для документа PPSX с помощью .NET API"
      content_left: |
    ...
    - title_left: "Как синхронно добавить документы PPSX в поисковый индекс"
      content_left: |
    ...
    - title_left: "Выполнение асинхронного индексирования документов через .NET"
      ...
      title_right: "Асинхронное PPSX индексирование документов с помощью C#"
      content_right: |
        * Для начала нужно указать путь к папке index
        * Укажите путь к папке с документами для поиска
        * Создайте экземпляр класса [Index(indexFolder)](https://apireference.groupdocs.com/search/net/groupdocs.search.indexrepository/search/methods/2).
    ...
    - title_left: "Как использовать и выделять результаты поиска в PPSX Docs .NET"
      content_left: |
      ...
      title_right: "Выделение результатов поиска в файлах PPSX с помощью C#"
      content_right: |
        * Поиск по индексу
