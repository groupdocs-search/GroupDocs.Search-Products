...
############################# Header ############################
title: "How to Add Instant Documents Search to PPT via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for PPT Document via .NET API"
      content_left: |
