...
############################# Header ############################
title: "How to Add Instant Documents Search to PPTM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for PPTM Document via .NET API"
      content_left: |
