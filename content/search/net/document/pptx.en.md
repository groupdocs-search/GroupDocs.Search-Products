...
############################# Head ############################
head_title: "Search PPTX documents in .NET with GroupDocs.Search"
...
steps:
    enable: true
    title: "How to perform text search in PPTX documents"
    content: |
      [GroupDocs.Search](/search/net/) enables advanced content search operations in PPTX documents, allowing refined search results in .NET applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Executing advanced search queries"
      content: |
        This example demonstrates how to apply search queries for PPTX documents.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
