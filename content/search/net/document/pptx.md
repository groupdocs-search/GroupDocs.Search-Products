...
############################# Header ############################
title: "How to Add Instant Documents Search to PPTX via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for PPTX Document via .NET API"
      content_left: |
