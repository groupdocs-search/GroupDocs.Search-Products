...
############################# Header ############################
title: "How to Add Instant Documents Search to PST via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for PST Document via .NET API"
      content_left: |
