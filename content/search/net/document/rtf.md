...
############################# Header ############################
title: "How to Add Instant Documents Search to RTF via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for RTF Document via .NET API"
      content_left: |
