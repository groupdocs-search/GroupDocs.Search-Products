...
############################# Header ############################
title: "How to Add Instant Documents Search to TXT via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for TXT Document via .NET API"
      content_left: |
