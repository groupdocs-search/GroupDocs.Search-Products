...
############################# Head ############################
head_title: "Pesquisar documentos TXT em .NET com GroupDocs.Search"
...
steps:
    enable: true
    title: "Como realizar busca textual em documentos TXT"
    content: |
      [GroupDocs.Search](/search/net/) permite operações avançadas de busca de conteúdo em documentos TXT, possibilitando resultados de busca refinados em aplicações .NET.
      
      1. Configure a pasta para armazenar o índice de busca.
      2. Escolha a pasta que contém arquivos TXT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Executando consultas de busca avançadas"
      content: |
        Este exemplo demonstra como aplicar consultas de busca para documentos TXT.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
