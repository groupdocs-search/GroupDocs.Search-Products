...
############################# Head ############################
head_title: "Tìm kiếm tài liệu TXT trong .NET với GroupDocs.Search"
...
steps:
    enable: true
    title: "Cách thực hiện tìm kiếm văn bản trong tài liệu TXT"
    content: |
      [GroupDocs.Search](/search/net/) cho phép thực hiện các thao tác tìm kiếm nội dung nâng cao trong các tài liệu TXT, cho kết quả tìm kiếm tinh chỉnh trong các ứng dụng .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Thực hiện các truy vấn tìm kiếm nâng cao"
      content: |
        Ví dụ này minh họa cách áp dụng các truy vấn tìm kiếm cho các tài liệu TXT.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
