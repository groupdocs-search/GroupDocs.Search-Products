...
draft: false
path: "search/net/document/xhtml"
...
############################# Header ############################
title: "How to Add Instant Documents Search to XHTML via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XHTML Document via .NET API"
      content_left: |
