...
draft: false
path: "zh/search/net/document/xhtml/"
...
############################# Header ############################
title: "如何通过 C# .NET API 将即时文档搜索添加到 XHTML"
...
steps:
    enable: true
    block:
    - title_left: "通过 .NET API 为 XHTML 文档创建搜索索引"
      content_left: |
    ...
    - title_left: "如何将 XHTML 文档同步添加到搜索索引"
      content_left: |
    ...
    - title_left: "通过 .NET 异步执行文档索引"
      ...
      title_right: "通过 C# 异步 XHTML 文档索引"
      content_right: |
        * 首先，您需要指定索引文件夹的路径
        * 指定包含要搜索的文档的文件夹的路径
        * 创建 [Index(indexFolder)](https://apireference.groupdocs.com/search/net/groupdocs.search.indexrepository/search/methods/2) 类的实例
