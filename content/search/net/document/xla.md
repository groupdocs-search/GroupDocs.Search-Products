...
############################# Header ############################
title: "How to Add Instant Documents Search to XLA via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLA Document via .NET API"
      content_left: |
