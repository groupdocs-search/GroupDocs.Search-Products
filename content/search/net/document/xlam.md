...
############################# Header ############################
title: "How to Add Instant Documents Search to XLAM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLAM Document via .NET API"
      content_left: |
