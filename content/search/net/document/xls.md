...
############################# Header ############################
title: "How to Add Instant Documents Search to XLS via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLS Document via .NET API"
      content_left: |
