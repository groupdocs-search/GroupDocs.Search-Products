...
############################# Header ############################
title: "How to Add Instant Documents Search to XLSB via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLSB Document via .NET API"
      content_left: |
