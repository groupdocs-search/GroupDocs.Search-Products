...
############################# Header ############################
title: "How to Add Instant Documents Search to XLSM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLSM Document via .NET API"
      content_left: |
