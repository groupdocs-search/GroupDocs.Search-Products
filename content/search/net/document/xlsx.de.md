...
############################# Head ############################
head_title: "Durchsuchen Sie XLSX-Dokumente in .NET mit GroupDocs.Search"
...
steps:
    enable: true
    title: "So führen Sie eine Textsuche in XLSX-Dokumenten durch"
    content: |
      [GroupDocs.Search](/search/net/) ermöglicht erweiterte Suchoperationen in XLSX-Dokumenten und liefert verfeinerte Suchergebnisse in .NET-Anwendungen.
      
      1. Richten Sie den Ordner ein, um den Suchindex zu speichern.
      2. Wählen Sie den Ordner mit den XLSX-Dateien.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausführen erweiterter Suchabfragen"
      content: |
        Dieses Beispiel zeigt, wie Suchabfragen für XLSX-Dokumente angewendet werden.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
