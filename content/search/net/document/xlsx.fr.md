...
############################# Head ############################
head_title: "Recherche de documents XLSX dans .NET avec GroupDocs.Search"
...
steps:
    enable: true
    title: "Comment effectuer une recherche textuelle dans des documents XLSX"
    content: |
      [GroupDocs.Search](/search/net/) permet des opérations de recherche de contenu avancées dans des documents XLSX, permettant des résultats de recherche affinés dans les applications .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Exécution de requêtes de recherche avancées"
      content: |
        Cet exemple démontre comment appliquer des requêtes de recherche pour des documents XLSX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
