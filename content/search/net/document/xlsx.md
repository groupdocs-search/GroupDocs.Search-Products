...
############################# Header ############################
title: "How to Add Instant Documents Search to XLSX via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLSX Document via .NET API"
      content_left: |
