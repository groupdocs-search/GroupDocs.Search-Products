...
############################# Header ############################
title: "How to Add Instant Documents Search to XLT via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLT Document via .NET API"
      content_left: |
