...
############################# Header ############################
title: "How to Add Instant Documents Search to XLTM via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLTM Document via .NET API"
      content_left: |
