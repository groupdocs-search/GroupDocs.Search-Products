...
############################# Header ############################
title: "How to Add Instant Documents Search to XLTX via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XLTX Document via .NET API"
      content_left: |
