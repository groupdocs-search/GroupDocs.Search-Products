...
############################# Header ############################
title: "How to Add Instant Documents Search to XML via C# .NET API "
...
steps:
    enable: true
    block:
    - title_left: "Search Index Creation for XML Document via .NET API"
      content_left: |
