...
draft: false
path: "ko/search/net/filters/ots/"
...
head_description: "GroupDocs.Search .NET API를 사용하면 소프트웨어 개발자가 OTS 문서 문서를 검색하고 .NET 앱에서 문서 필터링을 적용하여 검색 결과를 사용자 지정할 수 있습니다."
...
steps:
    enable: true
    block:
    - title_left: ".NET을 통해 OTS 문서 검색에서 문서 필터 설정"
      content_left: |
      ...
      title_right: "OTS 문서 검색 시 문서 필터 적용"
      content_right: |
    ...
    - title_left: ".NET을 통해 검색 문서 필터를 결합하는 방법"
      ...
      title_right: "OTS 파일 검색에서 검색 문서 필터 결합"
      content_right: |
       * 먼저 인덱스 폴더 및 문서 폴더의 경로를 지정해야 합니다.
