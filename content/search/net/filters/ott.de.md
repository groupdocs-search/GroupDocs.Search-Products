...
draft: false
path: "de/search/net/filters/ott/"
...
head_description: "GroupDocs.Search .NET API ermöglicht Softwareentwicklern, OTT Documents-Dokumente zu durchsuchen und die Suchergebnisse anzupassen, indem sie die Dokumentfilterung in .NET-Apps anwenden."
...
steps:
    enable: true
    block:
    - title_left: "Legen Sie den Dokumentfilter bei der Suche nach OTT-Dokumenten über .NET fest"
      content_left: |
      ...
      title_right: "Dokumentfilter beim Durchsuchen von OTT Dokumenten anwenden"
      content_right: |
    ...
    - title_left: "So kombinieren Sie Suchdokumentfilter über .NET"
      ...
      title_right: "Kombinieren Sie Suchdokumentfilter beim Durchsuchen von OTT-Dateien"
      content_right: |
       * Zuerst müssen Sie den Pfad zum Indexordner und Dokumentenordner angeben.
