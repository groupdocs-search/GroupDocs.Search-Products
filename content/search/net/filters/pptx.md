...
head_description: "GroupDocs.Search .NET API allows software developers to search out PPTX Documents documents and customize the search results by applying document Filtering in .NET Apps."
...
steps:
    enable: true
    block:
    - title_left: "Set Document Filter in Searching PPTX Documents via .NET"
      content_left: |
      ...
      title_right: "Apply Document Filter in Searching PPTX Documents"
      content_right: |
    ...
    - title_left: "How to Combine Search Document Filters via .NET"
      ...
      title_right: "Combine Search Document Filters in Searching PPTX Files"
      content_right: |
       * First you need to Specify the path to the index folder & document folder.
