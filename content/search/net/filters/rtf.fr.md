...
draft: false
path: "fr/search/net/filters/rtf/"
...
head_description: "L'API GroupDocs.Search .NET permet aux développeurs de logiciels de rechercher des documents RTF Documents et de personnaliser les résultats de la recherche en appliquant le filtrage de documents dans les applications .NET."
...
steps:
    enable: true
    block:
    - title_left: "Définir le filtre de document dans la recherche de rtf_documents UPPER via .NET"
      content_left: |
      ...
      title_right: "Appliquer le filtre de document dans la recherche de RTF documents"
      content_right: |
    ...
    - title_left: "Comment combiner des filtres de recherche de documents via .NET"
      ...
      title_right: "Combinez les filtres de recherche de documents dans la recherche de fichiers RTF"
      content_right: |
       * Vous devez d'abord spécifier le chemin d'accès au dossier d'index et au dossier de documents.
