...
draft: false
path: "zh/search/net/filters/xls/"
...
head_description: "GroupDocs.Search .NET API 允许软件开发人员搜索 XLS Documents 文档并通过在 .NET 应用程序中应用文档过滤来自定义搜索结果。"
...
steps:
    ...
    - title_left: "如何通过 .NET 组合搜索文档过滤器"
      ...
      title_right: "在搜索 XLS 文件时组合搜索文档过滤器"
      content_right: |
       * 首先，您需要指定索引文件夹和文档文件夹的路径。
