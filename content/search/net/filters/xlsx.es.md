...
draft: false
path: "es/search/net/filters/xlsx/"
...
head_description: "GroupDocs.Search .NET API permite a los desarrolladores de software buscar documentos de XLSX Documents y personalizar los resultados de la búsqueda mediante la aplicación de filtrado de documentos en aplicaciones .NET."
...
steps:
    enable: true
    block:
    - title_left: "Establecer filtro de documentos en la búsqueda de documentos XLSX a través de .NET"
      content_left: |
      ...
      title_right: "Aplicar filtro de documentos en la búsqueda de documentos XLSX"
      content_right: |
    ...
    - title_left: "Cómo combinar filtros de documentos de búsqueda a través de .NET"
      ...
      title_right: "Combinar filtros de documentos de búsqueda en la búsqueda de archivos XLSX"
      content_right: |
       * Primero debe especificar la ruta a la carpeta de índice y la carpeta de documentos.
