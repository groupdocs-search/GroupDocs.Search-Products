...
############################# Head ############################
head_title: "Recherche de phrases dans DOCX utilisant .NET"
...
steps:
    enable: true
    title: "Comment rechercher des phrases dans des documents DOCX"
    content: |
      [GroupDocs.Search](/search/net/) simplifie la recherche dans des documents DOCX. Utilisez différentes options pour affiner les résultats de recherche dans les applications .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Utilisation de techniques de recherche avancées"
      content: |
        Apprenez à créer des requêtes pour rechercher dans DOCX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
