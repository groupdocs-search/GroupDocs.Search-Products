...
############################# Head ############################
head_title: "Pesquisar frases em DOCX usando .NET"
...
steps:
    enable: true
    title: "Como buscar frases em documentos DOCX"
    content: |
      [GroupDocs.Search](/search/net/) simplifica a busca em documentos DOCX. Utilize várias opções para refinar os resultados da busca em aplicações .NET.
      
      1. Configurar a pasta do índice de busca.
      2. Especificar a pasta que contém arquivos DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Usando técnicas avançadas de busca"
      content: |
        Aprenda como criar consultas para busca em DOCX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
