...
############################# Head ############################
head_title: "¿Cómo agregar la búsqueda de frases en DOT Documentos en aplicaciones .NET?"
head_description: "GroupDocs.Search .NET API permite a las profesiones de software agregar búsqueda de frases y encontrar la frase exacta o la secuencia de palabras proporcionada en DOT documentos a través de .NET API."

############################# Header ############################
title: "¿Agregar búsqueda de frases o oraciones exactas en DOT Documentos dentro de aplicaciones .NET?"
description: "GroupDocs.Search .NET API permite a los programadores encontrar la secuencia de palabras proporcionada en DOT documentos a través de la búsqueda de frases o la búsqueda de oraciones exactas dentro de las aplicaciones .NET. "
...
steps:
    enable: true
    block:
    - title_left: "Cómo realizar una búsqueda de frases en documentos DOT a través de .NET"
      content_left: |
      ...
      title_right: "Búsqueda exacta de frases en DOT Documentos"
      content_right: |
    ...
    - title_left: "Búsqueda de frases con comodines en DOT Documentos a través de .NET"
      content_left: |
        GroupDocs.Search for .NET permite a los programadores de software agregar funcionalidades de búsqueda de frases utilizando comodines dentro de la aplicación C# .NET. Los siguientes ejemplos de código .NET muestran cómo aplicar la búsqueda de frases con comodines en documentos DOT dentro de aplicaciones C#.

      title_right: "Aplicar la búsqueda de frases con comodines en el archivo DOT"
      content_right: |
        * Primero debe especificar la ruta a la carpeta de índice y la carpeta de documentos.
