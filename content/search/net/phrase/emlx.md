...
############################# Head ############################
head_title: "How to Add Phrase Search in EMLX Documents in .NET Apps?"
head_description: "GroupDocs.Search .NET API enable software professions to add Phrase search and find the exact phrase or the provided sequence of words in EMLX documents via .NET API."
...
steps:
    enable: true
    block:
    - title_left: "How to Perform Phrase Search in EMLX Documents via .NET"
      content_left: |
      ...
      title_right: "Exact Phrase Search in EMLX Documents"
      content_right: |
    ...
    - title_left: "Wildcards Phrase Search in EMLX Documents via .NET"
      content_left: |
        GroupDocs.Search for .NET enables software programmers to add Phrase search functionalities using Wildcards inside C# .NET application. The following .NET code examples shows how to apply wildcards phrase search in EMLX Documents inside C# applications. 

      title_right: "Apply Wildcards Phrase Search in EMLX File"
      content_right: |
        * First you need to Specify the path to the index folder & document folder.
