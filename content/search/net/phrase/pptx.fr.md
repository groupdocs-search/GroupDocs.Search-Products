...
############################# Head ############################
head_title: "Recherche de phrases dans PPTX utilisant .NET"
...
steps:
    enable: true
    title: "Comment rechercher des phrases dans des documents PPTX"
    content: |
      [GroupDocs.Search](/search/net/) simplifie la recherche dans des documents PPTX. Utilisez différentes options pour affiner les résultats de recherche dans les applications .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Utilisation de techniques de recherche avancées"
      content: |
        Apprenez à créer des requêtes pour rechercher dans PPTX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
