...
############################# Head ############################
head_title: "Search phrases in TXT using .NET"
...
steps:
    enable: true
    title: "How to search phrases in TXT documents"
    content: |
      [GroupDocs.Search](/search/net/) simplifies searching in TXT documents. Use various options to refine search results in .NET applications.
      
      1. Set up the search index folder.
      2. Specify the folder containing TXT files.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Using advanced search techniques"
      content: |
        Learn how to create queries for searching in TXT.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
