...
############################# Head ############################
head_title: "Tìm kiếm cụm từ trong TXT bằng .NET"
...
steps:
    enable: true
    title: "Cách tìm kiếm cụm từ trong tài liệu TXT"
    content: |
      [GroupDocs.Search](/search/net/) đơn giản hóa việc tìm kiếm trong tài liệu TXT. Sử dụng các tùy chọn khác nhau để tinh chỉnh kết quả tìm kiếm trong các ứng dụng .NET.
      
      1. Cài đặt thư mục chỉ mục tìm kiếm.
      2. Xác định thư mục chứa các tệp TXT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sử dụng kỹ thuật tìm kiếm nâng cao"
      content: |
        Tìm hiểu cách tạo các truy vấn để tìm kiếm trong TXT.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
