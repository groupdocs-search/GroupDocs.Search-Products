...
draft: false
path: "de/search/net/phrase/xlsm/"
...
############################# Head ############################
head_title: "Wie füge ich eine Wortgruppensuche in XLSM-Dokumenten in .NET-Apps hinzu?"
head_description: "Die .NET-API von GroupDocs.Search ermöglicht es Softwarefachleuten, eine Wortgruppensuche hinzuzufügen und die genaue Wortgruppe oder die bereitgestellte Wortfolge in XLSM-Dokumenten über die .NET-API zu finden."

############################# Header ############################
title: "Genauen Satz oder Wortgruppe hinzufügen Suche in XLSM Dokumenten in .NET Apps?"
description: "Die .NET-API von GroupDocs.Search ermöglicht es Programmierern, die bereitgestellte Wortfolge in XLSM-Dokumenten über die Wortgruppensuche oder Suche nach genauen Sätzen in .NET-Apps herauszufinden."
...
steps:
    enable: true
    block:
    - title_left: "So führen Sie eine Wortgruppensuche in XLSM-Dokumenten über .NET durch"
      content_left: |
      ...
      title_right: "Suche nach exakten Ausdrücken in XLSM Dokumenten"
      content_right: |
    ...
    - title_left: "Wildcard-Phrasensuche in XLSM-Dokumenten über .NET"
      content_left: |
        GroupDocs.Search für .NET ermöglicht Softwareprogrammierern das Hinzufügen von Phrasensuchfunktionen mithilfe von Platzhaltern innerhalb der C# .NET-Anwendung. Die folgenden .NET-Codebeispiele zeigen, wie die Platzhalter-Phrasensuche in XLSM-Dokumenten in C#-Anwendungen angewendet wird.

      title_right: "Wenden Sie die Wildcard-Phrasensuche in der Datei XLSM an"
      content_right: |
        * Zuerst müssen Sie den Pfad zum Indexordner und Dokumentenordner angeben.
