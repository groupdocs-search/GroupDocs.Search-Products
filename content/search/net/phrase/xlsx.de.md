...
############################# Head ############################
head_title: "Suchphrasen in XLSX mit .NET"
...
steps:
    enable: true
    title: "So suchen Sie nach Phrasen in XLSX-Dokumenten"
    content: |
      [GroupDocs.Search](/search/net/) vereinfacht die Suche in XLSX-Dokumenten. Verwenden Sie verschiedene Optionen, um Suchergebnisse in .NET-Anwendungen zu verfeinern.
      
      1. Richten Sie den Ordner für den Suchindex ein.
      2. Geben Sie den Ordner an, der XLSX-Dateien enthält.
