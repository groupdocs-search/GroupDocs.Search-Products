...
head_description: "Quickly generate and embed a barcode signature in a PDF document with JavaScript using just a few lines of code. GroupDocs.Search supports signing across multiple file formats."
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/nodejs-java/) enables the generation and placement of barcodes in a variety of popular formats on PDF pages. With support for over 60 types of barcodes, Node.js via Java applications can be easily enhanced with barcode signing features by integrating our library.
