...
############################# Head ############################
head_title: "PDF 문서에 대한 불리언 검색 Node.js"
...
steps:
    enable: true
    title: "PDF 문서에서 불리언 연산자를 사용하여 검색하는 방법"
    content: |
      [GroupDocs.Search](/search/nodejs-java/)는 PDF 파일의 내용을 효과적으로 검색할 수 있게 해줍니다. 불리언 논리를 통해 Node.js via Java 애플리케이션 내에서 검색 쿼리를 세밀하게 조정하여 정확성을 향상시킬 수 있습니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "고급 불리언 검색의 예"
      content: |
        이 예제는 PDF 문서에서 내용을 검색하기 위한 불리언 기반 쿼리를 생성하는 방법을 보여줍니다.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
