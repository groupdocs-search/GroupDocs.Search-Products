...
############################# Head ############################
head_title: "Lakukan Pencarian Sensi Huruf Besar di DOCX dengan Node.js"
...
steps:
    enable: true
    title: "Langkah untuk Melakukan Pencarian Sensi Huruf Besar di File DOCX"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) memudahkan melakukan pencarian sensi huruf besar di file DOCX, meningkatkan alur kerja Node.js via Java Anda.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Contoh: Implementasi Pencarian Sensi Huruf Besar"
      content: |
        Contoh ini menunjukkan cara melakukan pencarian sensi huruf besar untuk dokumen DOCX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
