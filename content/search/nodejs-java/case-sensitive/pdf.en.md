...
############################# Head ############################
head_title: "Perform Case-Sensitive Searches in PDF with Node.js"
...
steps:
    enable: true
    title: "Steps for Performing Case-Sensitive Searches in PDF Files"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) makes it easy to carry out case-sensitive searches in PDF files, enhancing your Node.js via Java workflows.
