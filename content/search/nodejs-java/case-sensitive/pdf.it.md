...
############################# Head ############################
head_title: "Esegui ricerche sensibili al maiuscolo in PDF con Node.js"
...
steps:
    enable: true
    title: "Passaggi per Eseguire Ricerche Sensibili al Maiuscolo nei File PDF"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) rende semplice eseguire ricerche sensibili al maiuscolo nei file PDF, migliorando i tuoi flussi di lavoro Node.js via Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Esempio: Implementazione della Ricerca Sensibile al Maiuscolo"
      content: |
        Questo esempio dimostra come eseguire ricerche sensibili al maiuscolo per documenti PDF.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
