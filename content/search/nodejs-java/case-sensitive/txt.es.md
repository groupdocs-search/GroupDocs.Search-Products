...
############################# Head ############################
head_title: "Realiza búsquedas sensibles a mayúsculas en TXT con Node.js"
...
steps:
    enable: true
    title: "Pasos para Realizar Búsquedas Sensibles a Mayúsculas en Archivos TXT"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) facilita la realización de búsquedas sensibles a mayúsculas en archivos TXT, mejorando tus flujos de trabajo en Node.js via Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ejemplo: Implementación de Búsqueda Sensible a Mayúsculas"
      content: |
        Este ejemplo demuestra cómo realizar búsquedas sensibles a mayúsculas para documentos TXT.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
