...
############################# Head ############################
head_title: "Temukan teks dalam DOCX dengan GroupDocs.Search di Node.js"
...
steps:
    enable: true
    title: "Lakukan pencarian di file DOCX"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) memungkinkan Anda untuk melakukan pencarian dalam file DOCX, memperhalus hasil di aplikasi Node.js via Java.
      
      1. Tentukan folder penyimpanan untuk indeks pencarian.
      2. Pilih folder dengan file DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Menggunakan pencarian untuk dokumen DOCX"
      content: |
        Contoh ini menunjukkan cara menggunakan kueri pencarian dalam dokumen DOCX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
