...
############################# Head ############################
head_title: "Найдите текст в DOCX с помощью GroupDocs.Search в Node.js"
...
steps:
    enable: true
    title: "Выполните поиск в файлах DOCX"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) позволяет вам выполнять поиски в файлах DOCX, уточняя результаты в приложениях Node.js via Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Использование поиска для документов DOCX"
      content: |
        В этом примере показано, как использовать поисковые запросы в документах DOCX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
