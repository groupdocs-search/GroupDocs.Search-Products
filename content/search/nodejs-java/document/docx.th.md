...
############################# Head ############################
head_title: "ค้นหาข้อความใน DOCX ด้วย GroupDocs.Search ใน Node.js"
...
steps:
    enable: true
    title: "ดำเนินการค้นหาในไฟล์ DOCX"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) ช่วยให้คุณสามารถดำเนินการค้นหาในไฟล์ DOCX โดยการปรับผลลัพธ์ในแอปพลิเคชัน Node.js via Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "การใช้การค้นหาสำหรับเอกสาร DOCX"
      content: |
        ตัวอย่างนี้แสดงวิธีการใช้คำค้นหาในเอกสาร DOCX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
