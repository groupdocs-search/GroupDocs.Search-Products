...
############################# Head ############################
head_title: "Encontre texto em PDF com GroupDocs.Search em Node.js"
...
steps:
    enable: true
    title: "Realizar busca em arquivos PDF"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) permite executar buscas em arquivos PDF, refinando resultados em aplicações Node.js via Java.
      
      1. Defina uma pasta de armazenamento para o índice de busca.
      2. Selecione uma pasta com arquivos PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Usando busca para documentos PDF"
      content: |
        Este exemplo mostra como usar consultas de busca dentro de documentos PDF.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
