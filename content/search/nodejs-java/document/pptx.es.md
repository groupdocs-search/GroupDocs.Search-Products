...
############################# Head ############################
head_title: "Encuentra texto en PPTX con GroupDocs.Search en Node.js"
...
steps:
    enable: true
    title: "Realiza búsqueda en archivos PPTX"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) te permite ejecutar búsquedas en archivos PPTX, refinando resultados en aplicaciones Node.js via Java.
      
      1. Define una carpeta de almacenamiento para el índice de búsqueda.
      2. Selecciona una carpeta con archivos PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Uso de la búsqueda para documentos PPTX"
      content: |
        Este ejemplo muestra cómo utilizar consultas de búsqueda dentro de documentos PPTX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
