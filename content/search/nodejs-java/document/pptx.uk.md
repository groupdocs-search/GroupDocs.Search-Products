...
############################# Head ############################
head_title: "Знайдіть текст у PPTX за допомогою GroupDocs.Search в Node.js"
...
steps:
    enable: true
    title: "Виконання пошуку у файлах PPTX"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) дозволяє виконувати пошук у файлах PPTX, уточнюючи результати в програмах Node.js via Java.
      
      1. Визначте папку для зберігання індексу пошуку.
      2. Виберіть папку з файлами PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Використання пошуку для документів PPTX"
      content: |
        Цей приклад демонструє, як використовувати запити на пошук у документах PPTX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
