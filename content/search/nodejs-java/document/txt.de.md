...
############################# Head ############################
head_title: "Text in TXT mit GroupDocs.Search in Node.js finden"
...
steps:
    enable: true
    title: "Durchsuchen von TXT-Dateien"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) ermöglicht es Ihnen, Suchen in TXT-Dateien durchzuführen und die Ergebnisse in Node.js via Java-Anwendungen zu verfeinern.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Suchanfrage für TXT-Dokumente"
      content: |
        Dieses Beispiel zeigt, wie Suchabfragen innerhalb von TXT-Dokumenten verwendet werden.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
