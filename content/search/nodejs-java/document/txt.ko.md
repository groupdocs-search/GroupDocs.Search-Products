...
############################# Head ############################
head_title: "Node.js에서 TXT의 텍스트 검색하기 - GroupDocs.Search"
...
steps:
    enable: true
    title: "TXT 파일에서 검색 수행"
    content: |
      [GroupDocs.Search](/search/nodejs-java/)를 통해 TXT 파일에서 검색을 수행하여 Node.js via Java 애플리케이션 내에서 결과를 정제할 수 있습니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "TXT 문서에서 검색 사용하기"
      content: |
        이 예시는 TXT 문서 내에서 검색 쿼리를 사용하는 방법을 보여줍니다.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
