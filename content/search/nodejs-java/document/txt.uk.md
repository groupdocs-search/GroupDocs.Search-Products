...
############################# Head ############################
head_title: "Знайдіть текст у TXT за допомогою GroupDocs.Search в Node.js"
...
steps:
    enable: true
    title: "Виконання пошуку у файлах TXT"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) дозволяє виконувати пошук у файлах TXT, уточнюючи результати в програмах Node.js via Java.
      
      1. Визначте папку для зберігання індексу пошуку.
      2. Виберіть папку з файлами TXT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Використання пошуку для документів TXT"
      content: |
        Цей приклад демонструє, як використовувати запити на пошук у документах TXT.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
