...
############################# Head ############################
head_title: "在 TXT 中使用 GroupDocs.Search 查找文本，适用于 Node.js"
...
steps:
    ...
    title: "在 TXT 文件中执行搜索"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) 允许您在 TXT 文件中执行搜索，从而在 Node.js via Java 应用程序中精细化结果。
