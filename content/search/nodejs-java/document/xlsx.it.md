...
############################# Head ############################
head_title: "Trova testo in XLSX con GroupDocs.Search in Node.js"
...
steps:
    enable: true
    title: "Esegui ricerca in file XLSX"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) ti consente di eseguire ricerche in file XLSX, affinando i risultati nelle applicazioni Node.js via Java.
      
      1. Definisci una cartella di archiviazione per l'indice di ricerca.
      2. Seleziona una cartella con file XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Utilizzo della ricerca per documenti XLSX"
      content: |
        Questo esempio mostra come utilizzare query di ricerca all'interno di documenti XLSX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
