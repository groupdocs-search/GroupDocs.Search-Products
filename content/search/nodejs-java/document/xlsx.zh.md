...
############################# Head ############################
head_title: "在 XLSX 中使用 GroupDocs.Search 查找文本，适用于 Node.js"
...
steps:
    enable: true
    title: "在 XLSX 文件中执行搜索"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) 允许您在 XLSX 文件中执行搜索，从而在 Node.js via Java 应用程序中精细化结果。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "在 XLSX 文档中使用搜索"
      content: |
        此示例展示了如何在 XLSX 文档中使用搜索查询。
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
