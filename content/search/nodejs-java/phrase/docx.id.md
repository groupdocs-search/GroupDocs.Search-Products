...
############################# Head ############################
head_title: "Mencari frasa dalam DOCX menggunakan Node.js"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/nodejs-java/) memudahkan pencarian frasa dalam dokumen DOCX. Terapkan berbagai opsi pencarian untuk memperbaiki hasil dalam aplikasi Node.js via Java.
