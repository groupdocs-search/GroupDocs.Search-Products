...
############################# Head ############################
head_title: "Search phrases in PPTX using Node.js"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/nodejs-java/) makes phrase searching in PPTX documents easy. Apply different search options to refine results in Node.js via Java applications.
      
      1. Set up a search index folder.
      2. Define the folder containing PPTX files.
