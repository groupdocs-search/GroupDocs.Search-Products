...
############################# Head ############################
head_title: "Cerca frasi in TXT usando Node.js"
...
steps:
    enable: true
    title: "Come trovare frasi nei documenti TXT"
    content: |
      [GroupDocs.Search](/search/nodejs-java/) rende la ricerca di frasi nei documenti TXT semplice. Applica diverse opzioni di ricerca per perfezionare i risultati nelle applicazioni Node.js via Java.
      
      1. Imposta una cartella per l'indice di ricerca.
      2. Definisci la cartella contenente i file TXT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Utilizzare tecniche di ricerca avanzate"
      content: |
        Scopri come costruire query per la ricerca in TXT.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
