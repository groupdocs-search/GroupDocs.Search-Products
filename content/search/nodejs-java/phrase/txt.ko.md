...
############################# Head ############################
head_title: "TXT에서 구문 검색하기 - GroupDocs.Search for Node.js via Java"
...
steps:
    enable: true
    title: "TXT 문서에서 구문 찾는 방법"
    content: |
      [GroupDocs.Search](/search/nodejs-java/)을(를) 사용하면 TXT 문서에서 구문 검색을 수행할 수 있습니다. Node.js via Java 애플리케이션에서 결과를 정제하기 위해 다양한 검색 옵션을 적용하십시오.
      
      1. 검색 색인 폴더를 설정하십시오.
      2. TXT 파일이 포함된 폴더를 정의하십시오.
      3. 검색 매개변수를 구성하십시오.
