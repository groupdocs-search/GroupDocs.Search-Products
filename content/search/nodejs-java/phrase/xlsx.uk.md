...
############################# Head ############################
head_title: "Пошук фраз у XLSX за допомогою Node.js"
...
steps:
    ...
    content: |
      [GroupDocs.Search](/search/nodejs-java/) спрощує пошук фраз у документах XLSX. Застосуйте різні параметри пошуку, щоб уточнити результати в застосунках Node.js via Java.
      
      1. Налаштуйте папку для індексу пошуку.
      2. Визначте папку, що містить файли XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Використання розширених методів пошуку"
      content: |
        Дізнайтеся, як будувати запити для пошуку в XLSX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
